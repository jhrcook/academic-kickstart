GitHub repo: https://github.com/jhrcook/Colorizer
DeepAI Image Colorization API: https://deepai.org/machine-learning-model/colorizer

1. get API key or use the demo one, but it will eventually stop working
2. use `requests` to post an image to the API
3. use `requests` to download image


# How to use DeepAI's Image Colorization API to colorize black-and-white photos
